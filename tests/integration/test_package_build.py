...
def test_wheel_contains_runtime_prompt_assets_and_typing_marker(tmp_path: Path) -> None:
    ...
    prompt_files = {
        f"kg_processor/prompts/{prompt_name}.md" for prompt_name in PROMPT_REVISIONS
    }
