...
class EntityMention(BaseModel):
    ...
    evidence_method: Literal["llm", "llm_located", "llm_confirmed"] = "llm"
...
class RelationObservation(BaseModel):
    ...
    # ontology_cue: found by an ontology evidence cue without the model.
    evidence_method: Literal["llm", "llm_located", "ontology_cue"] = "llm"
